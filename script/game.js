...
function preload() {
  this.load.image('background', '../../script/assets/images/background.png');
  this.load.image('spike', '../../script/assets/images/spike.png');
  this.load.atlas('player', '../../script/assets/images/kenney_player.png',
    '../../script/assets/images/kenney_player_atlas.json');
  this.load.image('tiles', '../../script/assets/tilesets/platformPack_tilesheet.png');

  if(jsonLevel == null){

  }

  this.load.tilemapTiledJSON('map', '../../script/assets/tilemaps/' +jsonLevel);
	...
	$(document).ready(function($){
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR){
                        window.location.href = "/p/level-completed?level_number="+levelNumber + "&time_taken="+totalTime;
                    }
                });
            });
